...
const Contact: React.FC<Props> = ({ toggleTheme }) => {
  ...
  return (
    <ContainerContact id="contato">
      ...
      <SubContainerContact>
        <BoxContact href="mailto:viniciusbeserra1341@gmail.com">
          <Icon
            width="30"
            height="30"
            viewBox="0 0 30 30"
          ...
          <BoxTexts>
            <LinkText>Email para contato</LinkText>
          </BoxTexts>
        </BoxContact>

        <BoxContact
          target="blank"
          href="https://api.whatsapp.com/send?phone=558598445124"
        >
          <Icon
            width="31"
            height="30"
        ...
        <BoxCV href={pdf} download="Vinícius Beserra - Currículo">
          <Icon
            width="30"
            height="30"
            viewBox="0 0 30 30"
        ...
        <ContainerSocialMedias>
          <SocialMedia
            target="blank"
            href="https://www.linkedin.com/in/vinicius-beserra-araujo"
          >
            <Icon
              width="30"
              height="30"
          ...
          <SocialMedia
            target="blank"
            href="https://github.com/ViniciusBeserraA"
          >
            <Icon
              width="30"
              height="30"
          ...
          <SocialMedia
            target="blank"
            href="https://www.instagram.com/viniciusb1341"
          >
            <Icon
              xmlns="http://www.w3.org/2000/svg"
              width="30"
